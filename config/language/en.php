...
define("MESSAGE_EMAIL_REPEAT_WRONG", "Email repeat not match");
...
define("MESSAGE_PASSWORD_RESET_FAILED", "Password reset failed! Error: ");
...
define("MESSAGE_PASSWORD_RESET_LINK_VALID", "Reset link is valid.");
define("MESSAGE_PASSWORD_RESET_LINK_HAS_EXPIRED", "Your reset link has expired. Please use the reset link within one hour.");
define("MESSAGE_PASSWORD_RESET_LINK_INVALID", "Your reset link is invalid.");
